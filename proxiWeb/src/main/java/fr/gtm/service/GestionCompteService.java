...
public class GestionCompteService {
	 ...
	 * par la requete. Pour cela, elle recupere la totalit� des informations li�es
	 ...
	 * la requete. Pour cela, elle recupere la totalit� des informations li�es au
	...
	/**
	 * Methode qui realise un virement de compte � compte. Pour cela, elle credite
